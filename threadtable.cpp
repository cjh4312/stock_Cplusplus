...
//    QByteArray allData;
    ...
    if (GlobalVar::WhichInterface==1)
    {
        ...
        QString s="https://push2.eastmoney.com/api/qt/clist/get?pn=1&pz=6000&po=1&np=1&ut=bd1d9ddb04089700cf9c27f6f7426281&fltt=2&invt=1&fid=f22&fs="+fs+"&fields=f2,f3,f5,f6,f7,f8,f9,f10,f11,f12,f14,f15,f16,f17,f18,f20,f21,f22,f23,f24,f25,f26,f31,f32,f37,f38,f39,f40,f41,f45,f46,f49,f100,f102,f103,f129,f135&_=1667954879297";
    ...
    else
    {
        ...
        GlobalVar::getData(allData,3.5,QUrl("http://push2.eastmoney.com/api/qt/clist/get?pn=1&pz=5000&po=1&np=1&ut=bd1d9ddb04089700cf9c27f6f7426281&fltt=2&invt=2&fid=f6&fs="+fs+"&fields=f2,f3,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15,f16,f17,f18,f20,f21,f23,f24,f25,f22,f31,f32,f37,f40,f41,f45,f46,f49,f100,f102,f103,f129,f135&_=1667966922156"));
        if (GlobalVar::timeOutFlag[5])
            GlobalVar::timeOutFlag[5]=false;
        else
        {
    ...
    if (jsonError.error == QJsonParseError::NoError)
    {
        ...
        if (GlobalVar::WhichInterface==1)
        {
            ...
            for (int i = 0; i < data.size(); ++i)
            {
                ...
                info.listingDate=ceilMap.value("f26").toString();
                info.industry=ceilMap.value("f100").toString();
                info.region=ceilMap.value("f102").toString();
                info.concept=ceilMap.value("f103").toString();
                if (info.pctChg>=8)
                {
